...
void  makeArm()
{
  ...
  dReal  parts1_start_x[3] = {0, 0, 0};// 重心 y
  dReal  parts1_start_y[3] = {-0.08035, 0, 0.08035};// 重心 x
  ...
  dReal  parts2_start_x[3] = {0, 0, 0};// 重心 y
  dReal  parts2_start_y[3] = {-0.08, 0, 0.08};// 重心 x
  ...
  dReal  parts4_start_x[3] = {0, 0, 0};// 重心 y
  dReal  parts4_start_y[3] = {-0.05, 0, 0.05};// 重心 x
