...
void makeSensor()
{
  ...
  double r = 0.0001, weight = 0.01; // センサのサイズ[m]と重量[kg]
  ...
  //dJointAttach(sensor_joint, base.body, sensor); //
...
void  makeArm()
{
  ...
  dReal  parts1_x_length[3] = {0.15, 0.15, 0.15};
  dReal  parts1_y_length[3] = {0.067, 0.1, 0.067};
  dReal  parts1_z_length[3] = {0.195, 0.07, 0.195};
  dReal  parts1_start_x[3] = {0, 0, 0};// 重心 x
  dReal  parts1_start_y[3] = {-0.08035, 0, 0.08035};// 重心 y
  dReal  parts1_start_z[3] = {0.2975, 0.235, 0.2975};// 重心 z
  dReal  parts1_hinge_y[2] = {-0.05, 0.05};

  dReal  parts2_mass[3]  = {0.2, 0.4, 0.2};// 質量
  dReal  parts2_x_length[3] = {0.1, 0.1, 0.1};
  dReal  parts2_y_length[3] = {0.06, 0.1, 0.06};
  dReal  parts2_z_length[3] = {0.27, 0.26, 0.27};
  dReal  parts2_start_x[3] = {0, 0, 0};// 重心 x
  dReal  parts2_start_y[3] = {-0.08, 0, 0.08};// 重心 y
  dReal  parts2_start_z[3] = {0.59, 0.425, 0.59};// 重心 z
  dReal  parts2_hinge_y[2] = {-0.05, 0.05};
...
{
  dReal r,length;
  dReal parts1_length_02[] = {0.15, 0.067, 0.195};
  dReal parts1_length_1[] = {0.15, 0.1, 0.07};

  dReal parts2_length_02[] = {0.1, 0.06, 0.27};
  ...
  dReal parts6_length[3] = {0.08, 0.07, 0.03};
  dReal parts6_r[3] = {0.02, 0.04, 0.05};
...
void command(int cmd)
{
  switch (cmd) {
    ...
    case 'k': THETA[5] = M_PI/2; break;     // kキー
    case 'd': THETA[5] = M_PI/2; break;     // dキー
